<div class="md:justify-center p-5">
	<form class="md:w-2/3 space-y-5" wire:submit.prevent='crearTarea'>
		<div class="mb-2">
			<x-input-label for="expediente" :value="__('Numero de Expediente')" />
			<x-text-input id="expediente" class="block w-full" type="text"  wire:model="expediente"/>
		...
		<div class="mb-2">
			...
			<x-text-input id="ultimo_envio" class="block w-full" type="date" wire:model="ultimo_envio"/>
			<x-input-error :messages="$errors->get('ultimo_envio')"/>
		</div>
	
		<div class="mb-2">
			<x-input-label  for="ultima_correccion" :value="__('Ultima correcion')" />
			<x-text-input id="ultima_correccion" class="block w-full" type="date" wire:model="ultima_correccion"/>
